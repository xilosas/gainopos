...
export default {
    ...
    methods: {
        ...
        generate() {
            ...
            orderProducts = this.thermalInvoiceTemplate();
        ...
        thermalInvoiceTemplate(){
            ...
            this.final_cart.cart.forEach((element, i) => {
                ...
                if (element.orderType !== 'shipment') {
                    orderProduct.price = '<td>' + this.numberFormat(element.price) + ' x ' + parseInt(this.numberFormatting(element.quantity)) + '</td>';
                    // orderProduct.qty = '<td style="text-align:right;">' + parseInt(this.numberFormatting(element.quantity)) + '</td>';
                    orderProduct.discount = '<td class="dis">' + tempDiscount + '</td>';
                    orderProduct.total = '<td>' + this.numberFormat(element.calculatedPrice) + '</td>';
                    orderProducts = orderProducts + '<tr>' + orderProduct.productName + '</tr>' + '<tr>' + orderProduct.price + orderProduct.discount + orderProduct.total + '</tr>';
                } else {
