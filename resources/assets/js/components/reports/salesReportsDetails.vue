        ...
        <div>
            <div class="main-layout-wrapper">
                ...
                <div class="main-layout-card" style="padding-bottom: 20px;">
                    ...
                    <div v-else>
                        <div id="cart-print-area" v-html="reportRawHtml"
        ...
        getOrdersInfo() {
            ...
            this.axiosGet('/reports/ordersDetails/' + instance.id,
                function (response) {
                    ...
                    instance.invoice_size = response.data.templateData.invoice_size;

                    instance.reportRawHtml = response.data.largeInvoiceView;
