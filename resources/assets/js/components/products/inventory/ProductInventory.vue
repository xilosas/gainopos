                ...
                <div class="main-layout-card-content-wrapper">
                    ...
                    <div class="main-layout-card-header-contents text-right">
                        <button
                            ...
                            @click.prevent="exportAll('/export/all/report/inventory')">
                                {{ trans('lang.export_all') }}
                        </button>
                       <common-submit-button
                           :buttonLoader="buttonLoader" :isDisabled="isDisabled"
...
import ExportAllMixin from "../products/mixins/ExportAllMixin";
